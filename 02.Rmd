# Imagine knowing what's going on in the water with a trout food source before showing up... {Predicting the Hatch}
...
## Leverage a bot to allow for interaction to input Long, Lat, or river input to respond with predicted hatches.
